...
<body>
                    ...
                    <table id="board-table">
                        ...
                        <tbody>
                        	<c:forEach var="board" items="${list }">
	                            <tr>
	                                <td>${board.bno }</td>                             
	                                <td class="title" data-url="<c:url value='/board/read?bno=${board.bno }&${ph.sc.queryString }&mode=notice'/>">
						                ${board.title }
						            </td>
	                                <td>${board.writer }</td>
	...
	<script>
		...
		document.addEventListener('DOMContentLoaded', function() {
		    const active = document.querySelector("#notice-title");
		    if(active) {
		        active.classList.add("activeMenu");
		    }
		});
